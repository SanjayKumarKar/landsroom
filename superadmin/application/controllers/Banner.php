...
//Set Common things for this controller*************************************************************
	...
	function  __construct() {
        parent::__construct();
        $this->COMMON['DB']='tb_banner';
        $this->COMMON['ID_FIELD']='banner_id';
        $this->COMMON['VIEW_CONTROLLER']='banner';
...
//Add Form Submission	
	public function addSubmitted()
	{
		...
		$this->form_validation->set_rules('banner_image_desktop','Desktop Image','required');
		$this->form_validation->set_rules('banner_image_mobile','Mobile Image','required');
		...
		if($this->form_validation->run()) 
		{
			...
			$insertData = array(
					...
					'banner_button_text' => $this->input->post('banner_button_text'),
					'banner_url' => $this->input->post('banner_url'),
					'banner_image_desktop' => $this->input->post('banner_image_desktop'),
					'banner_image_mobile' => $this->input->post('banner_image_mobile')
			);
...
//Data Fetch**************************************************************************	
	 ...
	 public function getData()
	 {
			...
			$searColumns = array('banner_order','banner_title');
			...
			if(count($results['DATA'])>0){
				foreach ($results['DATA'] as $DATA) {
					...
					$nestedData[] = $DATA['banner_order'];
					$nestedData[] = $DATA['banner_title'];
