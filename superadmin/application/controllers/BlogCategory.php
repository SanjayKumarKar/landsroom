...
//Set Common things for this controller*************************************************************
	...
	function  __construct() {
        parent::__construct();
        $this->COMMON['DB']='tb_blog_category';
        $this->COMMON['ID_FIELD']='blog_category_id';
        $this->COMMON['VIEW_CONTROLLER']='blogCategory';
...
//Initialize Common Details
	private function initData()
	{
		...
		$this->common_data['title'] 			= 	'Blog Category';
...
//Add Form Submission	
	public function addSubmitted($CALL_TYPE='NORMAL')
	{
		...
		$this->form_validation->set_rules('blog_category_title','Title','required');
		...
		if($this->form_validation->run()) 
		{
			...
			$insertData = array(
					...
					'blog_category_details' => $this->input->post('blog_category_details',false)
			);
...
//Data Fetch**************************************************************************	
	 ...
	 public function getData()
	 {
			...
			$searColumns = array('blog_category_title');
			...
			if(count($results['DATA'])>0){
				foreach ($results['DATA'] as $DATA) {
					...
					$nestedData[] = $DATA['blog_category_title'];
