...

{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null, $directory='') {
        ...
        $this->options = array(
            ...
            'inline_file_types' => '/\.(gif|jpe?g|png|svg|webp|pdf|mp3|mp4|wav|doc|docx|ppt|txt)$/i',
            ...
            'accept_file_types' => '/\.(gif|jpe?g|png|svg|webp|pdf|mp3|mp4|wav|doc|docx|ppt|txt)$/i',
