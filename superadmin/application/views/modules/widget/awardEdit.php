												...
												<div class="row">
													...
													<div class="col-md-12">
														...
														<div class="form-group">
															...
															<input type="number" class="form-control" name="widget_order" id="widget_order" min="1" value="<?=$list[0]['widget_order'];?>" required> 
														...
														<div class="form-group">
															...
															<input type="text" class="form-control" name="widget_details[title]" value="<?=$DATA['title'];?>" required> 
