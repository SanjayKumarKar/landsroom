								...
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										...
										<form action="<?=base_url($view_controller.'/addSubmitted');?>" role="form" method="post" class="horizontal-form" id="form_sample_1" enctype="multipart/form-data">
											<input type="hidden" name="widget_area" value="award">
											<div class="form-body">

												<h3 class="form-section">Award Info</h3>
												...
												<div class="row">
													...
													<div class="col-md-12">
														...
														<div class="form-group">
															...
															<input type="number" class="form-control" name="widget_order" id="widget_order" min="1" required> 
														...
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input type="text" class="form-control" name="widget_details[featured_image]" id="featured_image"  pattern="([\w.%+-\/]+.png)|([\w.%+-\/]+.jpg)|([\w.%+-\/]+.jpeg)|([\w.%+-\/]+.gif)" readonly> 
																<span class="input-group-btn">
														...
														<div class="form-group">
															...
															<input type="text" class="form-control" name="widget_details[title]" required> 
