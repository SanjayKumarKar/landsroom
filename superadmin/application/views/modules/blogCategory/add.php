												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															<label>Title</label>
															<input type="text" class="form-control" name="blog_category_title" id="blog_category_title" value="<?=set_value('blog_category_title');?>" required> 
														</div>
													</div>
													<div class="col-md-12 ">
														<div class="form-group">
															<label>Description</label>
															<textarea class="form-control"  name="blog_category_details" rows="5"></textarea>
														</div>
													</div>
												</div>
											</div>
