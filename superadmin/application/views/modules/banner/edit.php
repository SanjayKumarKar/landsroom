												...
												<div class="row">
													<div class="col-md-6 ">
														<div class="form-group">
															<label>Order</label>
															<input type="text" class="form-control" name="banner_order" id="banner_order" value="<?=$list[0]['banner_order']?>" required> 
														</div>
														<div class="form-group">
															<label>Title</label>
															<input type="text" class="form-control" name="banner_title" id="banner_title" value="<?=$list[0]['banner_title']?>" required> 
														</div>
														<div class="form-group">
															<label>URL</label>
															<input type="text" class="form-control" name="banner_url" id="banner_url" value="<?=$list[0]['banner_url']?>" required> 
														</div>
													</div>
													...
													<div class="col-md-6 ">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="banner_button_text" id="banner_button_text" value="<?=$list[0]['banner_button_text']?>"> 
														</div>
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input type="text" class="form-control" name="banner_image_desktop" id="banner_image_desktop" value="<?=$list[0]['banner_image_desktop']?>" required readonly> 
																<span class="input-group-btn">
														...
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input type="text" class="form-control" name="banner_image_mobile" id="banner_image_mobile" value="<?=$list[0]['banner_image_mobile']?>"  required readonly> 
																<span class="input-group-btn">
