...
*/
 ...
 $ACCESS_PWD='dsdaTechSupport'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 
/* 'user'=>"nims_2020",#required
 'pwd'=>"nims_2020@@@2020", #required
 'db'=>"nims_2020",  #optional, default DB*/
	 
/* 'user'=>"srmunive_webusr",#required
 'pwd'=>"WqZ@%9REG)4wx", #required
 'db'=>"srmunive_wdatabank2021",  #optional, default DB
*/	 
/*	 
  'user'=>"root",#required
 'pwd'=>"gbG8$123", #required
 'db'=>"anuassets",  #optional, default DB
	 
*/	 
		
 'user'=>"dsdagov_dsda",#required
 'pwd'=>"Hello@#v3", #required
 'db'=>"dsdagov_swagata",  #optional, default DB
		
	 
/* 'user'=>"anantu_web", #required
 'pwd'=>"M0KsnxlfcsO0SS4o", #required
 'db'=>"anu.edu.in_15022023",  #optional, default DB
