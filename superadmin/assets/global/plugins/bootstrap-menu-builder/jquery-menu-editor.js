...
function MenuEditor(idSelector, options) {
    ...
    function TButtonGroup() {
        var $divbtn = $('<div style="float: right;">').addClass('btn-group');
        ...
        var $btnUp = TButton({classCss: 'btn btn-info btn-sm btnUp btnMove', text: '<i class="fas fa-angle-up clickable"></i>'});
        var $btnDown = TButton({classCss: 'btn btn-info btn-sm btnDown btnMove', text: '<i class="fas fa-angle-down clickable"></i>'});
        var $btnOut = TButton({classCss: 'btn btn-warning btn-sm btnOut btnMove', text: '<i class="fas fa-level-down-alt clickable"></i>'});
        var $btnIn = TButton({classCss: 'btn btn-warning btn-sm btnIn btnMove', text: '<i class="fas fa-level-up-alt clickable"></i>'});
