            ...
            <div class="row justify-content-between">
                <div class="col-md-5">
                    <div class="sticky-card">
                        <div class="sales-tab">
                            <div class="tab-group d-block text-center mb-3">
                                <button type="button" class="btn-tab treat-tab active" onclick="showBox(this,'omega')">Basic Details</button>

                                <button type="button" class="btn-tab treat-tab " onclick="showBox(this,'omega1')">Location Details</button>

                                <button type="button" class="btn-tab treat-tab " onclick="showBox(this,'omega2')">Property Details</button>
                                <button type="button" class="btn-tab treat-tab " onclick="showBox(this,'omega3')">Documantation Details</button>
                                <button type="button" class="btn-tab treat-tab " onclick="showBox(this,'omega4')">Other Details</button>
                                <button type="button" class="btn-tab treat-tab " onclick="showBox(this,'omega5')">Amenities Details</button>
                            </div>
                ...
                <div class="col-md-7 property-post-section">
                    <div class="details-form">
                        <form action="<?=site_url('Operation/updateUserType')?>" method="post" class="form">
                            <!-- Steps -->
                            ...
                            ?>
                              <!-- print_r($DETAILS); die();  -->
                            <div class="treat-box" id="omega" style="display: block;">
                                <div class="form">
                                    ...
                                    <div class="row">
                                        ...
                                        </div> 0=Buyer,1=Owner,2=Terant,3=Agent,4=Builder-->	
                                        <div class="col-12 mb-3">
                                            <label for="exampleInputEmail1" class="form-label d-block">You are :</label>
                                            <div class="days-btn-container">
                                                <?php foreach ($userTypes as $key => $value): ?>
                                                    <div class="position-relative">
                                                        <input class="day-btn" name="user_type[]" value="<?= $key ?>" id="<?= $value ?>" type="checkbox" 
                                                            <?= in_array((string) $key, $selectedUserTypes) ? 'checked' : '' ?> />
                                                        <label class="day-label" for="<?= $value ?>"><?= $value ?></label>
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="btn-group">
                                            <input type="submit" value="Save Changes" name="Save Changes" class="btn btn-complete">
                                        </div>
                            ...
                            <div class="treat-box" id="omega1" style="display: none;">
                            ...
                            <div class="treat-box" id="omega2" style="display: none;">
                                <div class="form ">
                            ...
                            <div class="treat-box" id="omega3" style="display: none;">
                                <div class="form">
                            ...
                            <div class="treat-box" id="omega4" style="display: none;">
                                <div class="form ">
                            ...
                            <div class="treat-box" id="omega5" style="display: none;">
